...
compute-model-accuracy: ## Compute model accuracy and cache results  [METRIC=top1]
	python scripts/analysis/model_accuracy/compute_model_accuracy.py --metric $(METRIC)
